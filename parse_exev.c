 ...
 * @info: denotes the info struct
 * @path: denotes path to the file
 *
 ...
 * @pathstr: denotesthe PATH string
 * @start: denotes the starting index
 * @stop: denotes the stopping index
 *
 ...
 * @info: denotes the info struct
 * @pathstr: denotes the PATH string
 * @cmd: denotes the cmd to find
 *
